...
function AboutPage() {
  return (
    <div className="flex flex-col gap-16">
      <div
        className={`flex ${iowan.className} flex-col gap-4 mt-16 text-xl max-w-2xl mx-auto leading-8`}
      >
        <h1 className="mt-16 mb-4 text-4xl leading-12">/ Leslie Cavalier /</h1>
        <p>
        ...
        <div className="max-w-2xl my-16 p-8 bg-blue-900 mt-[100px] text-white">
          <p className="mt-[120px]">
            <div className="max-w-[520px] pr-[120px]">
